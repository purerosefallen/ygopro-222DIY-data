...
function c9980452.thfilter1(c)
	return c:IsSetCard(0x2bca) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
...
function c9980452.spfilter(c,e,tp,dc)
	return c:IsSetCard(0x2bca) and c:GetOriginalCode()~=dc:GetOriginalCode() and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
