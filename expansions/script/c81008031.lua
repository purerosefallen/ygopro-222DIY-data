...
function c81008031.initial_effect(c)
	...
	e1:SetCondition(c81008031.condition)
	e1:SetTarget(c81008031.target)
	e1:SetOperation(c81008031.activate)
	c:RegisterEffect(e1)
end
function c81008031.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c81008031.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local opt=Duel.SelectOption(1-tp,aux.Stringid(81008031,0),aux.Stringid(81008031,1))
	if opt==1 then
