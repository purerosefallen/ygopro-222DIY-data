...
function c1103023.spfilter(c,e,tp)
    return c:IsCode(1103022) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c1103023.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
    if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingTarget(c1103023.spfilter,tp,LOCATION_GRAVE+LOCATION_DECK,0,1,nil,e,tp) end
