...
function c47594147.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
    if chk==0 then return Duel.IsExistingMatchingCard(c47594147.spfilter,tp,LOCATION_EXTRA,0,1,nil,tp) and Duel.IsExistingMatchingCard(c47594147.tgfilter,tp,LOCATION_DECK,0,1,nil) end
