...
function c81015007.cfilter(c)
	return c:IsSetCard(0x814) and c:IsType(TYPE_MONSTER) and c:IsAbleToRemoveAsCost()
end
...
function c81015007.filter(c,e,tp)
	return c:IsSetCard(0x814) and c:IsLinkBelow(3) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
