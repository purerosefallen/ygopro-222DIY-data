...
function c47501005.initial_effect(c)
    --material
    c:EnableReviveLimit() 
    aux.AddXyzProcedureLevelFree(c,c47501005.mfilter,c47501005.xyzcheck,2,2)
    --pendulum summon
...
function c47501005.disop(e,tp,eg,ep,ev,re,r,rp)
    ...
    if (re:IsActiveType(TYPE_SPELL) or re:IsActiveType(TYPE_TRAP)) and not re:IsActiveType(TYPE_PENDULUM) and bit.band(loc,LOCATION_SZONE)~=0 then
