...
function cm.backon(e,tp,eg,ep,ev,re,r,rp)
	...
	return c.dfc_front_side and c:GetOriginalCode()==c.dfc_back_side3
end
...
function cm.setop3(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:IsRelateToEffect(e) then
		local tcode4=c.dfc_back_side4
		c:SetEntityCode(tcode4,true)
		c:ReplaceEffect(tcode4,0,0)
