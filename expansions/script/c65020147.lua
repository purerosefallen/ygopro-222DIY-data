...
function c65020147.sprcon(e,c)
	...
	return Duel.IsExistingMatchingCard(c65020147.sprfilter,tp,LOCATION_MZONE,0,2,nil,tp,c) and Duel.GetLocationCountFromEx(tp)>0
end
function c65020147.sprfilter(c,tp,fc)
	return c:IsFusionType(TYPE_FLIP) and c:IsAbleToGraveAsCost() and c:IsCanBeFusionMaterial(fc)
end
