...
function c13255219.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(13255219,2))
	e4:SetCategory(CATEGORY_TODECK)
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e4:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e4:SetCode(EVENT_SPSUMMON_SUCCESS)
	e4:SetCondition(c13255219.tdcon)
	e4:SetTarget(c13255219.tdtg)
	e4:SetOperation(c13255219.tdop2)
	c:RegisterEffect(e4)
...
function c13255219.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c13255219.filter,tp,LOCATION_MZONE,0,1,e:GetHandler()) end
