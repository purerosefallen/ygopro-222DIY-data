...
function c65060022.discost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c65060022.filter,tp,LOCATION_MZONE,0,1,nil) end
	local g=Duel.SelectMatchingCard(tp,c65060022.filter,tp,LOCATION_MZONE,0,1,1,nil)
...
function c65060022.distg(e,tp,eg,ep,ev,re,r,rp,chk)
