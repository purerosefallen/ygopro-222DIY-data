...
function c65010117.initial_effect(c)
	...
	e1:SetCondition(c65010117.aclicon1)
	e1:SetValue(c65010117.aclimit)
	c:RegisterEffect(e1)
	local e3=e1:Clone()
	e3:SetTargetRange(0,1)
	e3:SetCondition(c65010117.aclicon2)
	c:RegisterEffect(e3)
	--spsummon
...
function c65010117.acconfil(c)
	return c:IsSetCard(0x5da0) and c:IsFaceup()
end
function c65010117.aclicon1(e)
	local tp=e:GetHandlerPlayer()
	return Duel.IsExistingMatchingCard(c65010117.acconfil,tp,LOCATION_MZONE,0,1,nil)
end
function c65010117.aclicon2(e)
	local tp=e:GetHandlerPlayer()
	return Duel.IsExistingMatchingCard(c65010117.acconfil,tp,0,LOCATION_MZONE,1,nil)
end
