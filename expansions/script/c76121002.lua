...
function c76121002.initial_effect(c)
	...
	e2:SetCondition(c76121002.stcon)
...
function c76121002.stcon(e,tp,eg,ep,ev,re,r,rp)
...
function c76121002.sttg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_SZONE)>0
		and Duel.IsExistingMatchingCard(c76121002.filter,tp,LOCATION_DECK,0,1,nil) end
end
function c76121002.stop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SET)
	local g=Duel.SelectMatchingCard(tp,c76121002.filter,tp,LOCATION_DECK,0,1,1,nil)
