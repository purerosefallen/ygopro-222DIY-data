...
function c47514896.initial_effect(c)
	...
	e8:SetOperation(c47514896.sumsuc)
	c:RegisterEffect(e8)
end
...
function c47514896.effop(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if tc:IsRelateToEffect(e) then
		...
		Duel.Hint(HINT_SOUND,0,aux.Stringid(47514896,4))
	end  
end
function c47514896.sumsuc(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SOUND,0,aux.Stringid(47514896,3))
end 