...
function c1000420.cfilter1(c)
	return c:IsSetCard(0xa201) and c:IsAbleToDeckAsCost()
end
function c1000420.thcost1(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToHandAsCost()
		and Duel.IsExistingMatchingCard(c1000420.cfilter1,tp,LOCATION_REMOVED,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TODECK)
	local g=Duel.SelectMatchingCard(tp,c1000420.cfilter1,tp,LOCATION_REMOVED,0,1,1,nil)
	g:AddCard(e:GetHandler())
