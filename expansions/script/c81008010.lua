...
function c81008010.initial_effect(c)
	...
	e0:SetDescription(aux.Stringid(81008010,0))
	e0:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_CONTINUOUS)
	e0:SetCode(EVENT_SPSUMMON_SUCCESS)
	e0:SetCondition(c81008010.sumcon)
	e0:SetOperation(c81008010.sumsuc)
	c:RegisterEffect(e0)
	--spsummon condition
...
function c81008010.sumcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_EXTRA)
end
function c81008010.sumsuc(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_MUSIC,0,aux.Stringid(81008010,1))
end
