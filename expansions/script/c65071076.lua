...
function c65071076.initial_effect(c)
	...
	e1:SetCountLimit(1,65071150+EFFECT_COUNT_CODE_OATH)
	e1:SetTarget(c65071076.target)
	e1:SetOperation(c65071076.activate)
	c:RegisterEffect(e1)
	local e2=Effect.CreateEffect(c)
	e2:SetCategory(CATEGORY_NEGATE+CATEGORY_DISABLE+CATEGORY_REMOVE)
...
function c65071076.discon(e,tp,eg,ep,ev,re,r,rp)
	...
	return (ex4 or ex5) and (Duel.IsChainNegatable(ev) or Duel.IsChainDisablable)
end
