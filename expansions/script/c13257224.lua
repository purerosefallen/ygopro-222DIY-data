...
function c13257224.initial_effect(c)
	...
	e11:SetValue(c13257224.eqlimit)
	...
	e12:SetCondition(c13257224.econ)
	e12:SetValue(c13257224.efilter)
	...
	e4:SetOperation(c13257224.acop)
	c:RegisterEffect(e4)
	--Negate
	local e5=Effect.CreateEffect(c)
	e5:SetDescription(aux.Stringid(13257224,0))
	e5:SetCategory(CATEGORY_NEGATE)
	e5:SetType(EFFECT_TYPE_QUICK_F)
	e5:SetCode(EVENT_CHAINING)
	e5:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DAMAGE_CAL)
	e5:SetRange(LOCATION_SZONE)
	e5:SetCost(c13257224.cost)
	e5:SetCondition(c13257224.codisable)
	e5:SetTarget(c13257224.tgdisable)
	e5:SetOperation(c13257224.opdisable)
	c:RegisterEffect(e5)
	c:RegisterFlagEffect(13257201,0,0,0,3)
	
end
function c13257224.eqlimit(e,c)
...
function c13257224.econ(e)
	return e:GetHandler():GetEquipTarget()
end
function c13257224.efilter(e,re)
...
function c13257224.tgdisable(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_NEGATE,eg,1,0,0)
end
function c13257224.opdisable(e,tp,eg,ep,ev,re,r,rp)
