...
function c47550003.thfilter(c)
    return c:IsSetCard(0x5d0) and c:IsType(TYPE_MONSTER) and c:IsType(TYPE_PENDULUM) and not c:IsCode(47550003) and c:IsAbleToHand()
end
...
function c47550003.cfilter(c,tp)
    return c:IsReason(REASON_BATTLE+REASON_EFFECT) and (c:IsRace(RACE_SPELLCASTER) or c:IsRace(RACE_WARRIOR) or c:IsAttribute(ATTRIBUTE_WATER))
