...
function c65020045.reop(e,tp,eg,ep,ev,re,r,rp)
	if not Duel.IsExistingMatchingCard(c65020045.thfil,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,nil) then return end
	local g=Duel.SelectMatchingCard(tp,c65020045.thfil,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,1,nil)
