...
function rstg.list(valuetype,...)
	...
	for _,target in pairs(costlist) do
		target[10]=false
		target[11]=false
	end  
	return targetlist
...
function rsop.list(valuetype,...)
	...
	for _,operation in pairs(operationlist) do
		operationlist[10]=true
		operationlist[11]=false
	end  
...
function rscost.CostCheck(e,tp,eg,ep,ev,re,r,rp,chk,valuetype,...)
	local costlist=rscost.list(valuetype,...)
	return rstg.TargetCheck(e,tp,eg,ep,ev,re,r,rp,chk,nil,table.unpack(costlist))
end
--cost select
function rscost.CostSelectNoInfo(e,tp,eg,ep,ev,re,r,rp,valuetype,...)
	local costlist=rscost.list(valuetype,...)
	local _,_,costtotalgroup,costinfolist,costinfoindexlist = rstg.TargetSelectNoInfo(e,tp,eg,ep,ev,re,r,rp,table.unpack(costlist))
