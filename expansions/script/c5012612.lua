...
function c5012612.initial_effect(c)
    ...
    --link summon
    aux.AddLinkProcedure(c,aux.FilterBoolFunction(Card.IsLinkSetCard,0x250),1,1)
    c:EnableReviveLimit()
    --aux.AddFusionProcFunRep(c,aux.FilterBoolFunction(Card.IsFusionSetCard,0x350),2,true)
