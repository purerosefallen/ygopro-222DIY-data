...
function c12017010.sprcon(e,c)
	...
	return Duel.IsExistingMatchingCard(c12017010.spfilter,tp,LOCATION_HAND,0,3,nil) and Duel.GetFieldGroupCount(tp,LOCATION_ONFIELD,0)==0 and Duel.GetLocationCountFromEx(tp)>0
end
