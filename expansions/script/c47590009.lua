...
function c47590009.initial_effect(c)
    ...
    e3:SetCountLimit(1)
    e3:SetCost(c47590009.atkcost)
    e3:SetOperation(c47590009.atkop)
    c:RegisterEffect(e3)
    --actlimit
...
function c47590009.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
    if chk==0 then return e:GetHandler():CheckRemoveOverlayCard(tp,1,REASON_COST) end
    e:GetHandler():RemoveOverlayCard(tp,1,1,REASON_COST)
end
function c47590009.atkop(e,tp,eg,ep,ev,re,r,rp)
