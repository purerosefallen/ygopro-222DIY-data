...
function c9980212.matfilter(c)
	return c:IsLinkType(TYPE_NORMAL) and c:IsLinkRace(RACE_FAIRY)and not c:IsLinkType(TYPE_TOKEN)
end
...
function c9980212.filter(c,e,tp)
	return c:IsType(TYPE_NORMAL) and (c:IsRace(RACE_FAIRY) or c:IsAttribute(ATTRIBUTE_LIGHT))
