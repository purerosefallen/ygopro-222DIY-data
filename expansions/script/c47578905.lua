...
function c47578905.initial_effect(c)
    ...
    e1:SetTarget(c47578905.psplimit)
    c:RegisterEffect(e1) 
    --pendulum set
    local e2=Effect.CreateEffect(c)
    e2:SetDescription(aux.Stringid(47578905,1))
    e2:SetType(EFFECT_TYPE_IGNITION)
    e2:SetRange(LOCATION_PZONE)
    e2:SetCountLimit(1,47578905)
    e2:SetCost(c47578905.cost)
    e2:SetTarget(c47578905.pctg)
    e2:SetOperation(c47578905.pcop)
    c:RegisterEffect(e2)
    --spssummon
