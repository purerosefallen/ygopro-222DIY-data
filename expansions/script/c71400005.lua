...
function c71400005.initial_effect(c)
	...
	el1:SetCondition(c71400005.sumlimit)
...
function c71400005.lfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x3714)
end
function c71400005.sumlimit(e)
	return not Duel.IsExistingMatchingCard(c71400005.lfilter,e:GetHandlerPlayer(),LOCATION_FZONE,0,1,nil)
end
