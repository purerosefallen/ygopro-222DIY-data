...
function cm.discon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(14000204)~=0 and re:GetHandler()~=e:GetHandler() and e:GetHandler():GetFlagEffect(m)<3 and not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED)
end
