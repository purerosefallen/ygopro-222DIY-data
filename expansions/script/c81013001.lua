...
function c81013001.tdfilter(c)
	return c:IsLevel(7) and c:IsFaceup()
end
function c81013001.negtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(1-tp) and c81013001.tdfilter(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c81013001.tdfilter,tp,0,LOCATION_MZONE,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_FACEUP)
	local g=Duel.SelectTarget(tp,c81013001.tdfilter,tp,0,LOCATION_MZONE,1,1,nil)
