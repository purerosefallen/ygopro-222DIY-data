...
function c12005005.initial_effect(c)
	...
	e2:SetCondition(c12005005.spcon)
...
function c12005005.spcost(e,tp,eg,ep,ev,re,r,rp,c)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	local g=Duel.GetMatchingGroup(c12005005.cfilter,tp,LOCATION_EXTRA,0,c)
	local rg=nil
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
		rg=g:Select(tp,5,5,nil)
	Duel.Remove(rg,POS_FACEDOWN,REASON_COST)
end
function c12005005.spcon(e,tp,eg,ep,ev,re,r,rp)
