...
function c81009028.initial_effect(c)
	...
	e2:SetCondition(c81009028.indcon)
	e2:SetValue(1)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	...
	e4:SetCountLimit(1,81009028)
	e4:SetCost(c81009028.spcost)
...
function c81009028.value(e,c)
	return Duel.GetMatchingGroupCount(c81009028.filter,0,LOCATION_MZONE,LOCATION_MZONE,nil)*700
end
function c81009028.indcon(e)
	return Duel.IsExistingMatchingCard(Card.IsType,e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil,TYPE_TOKEN)
end
function c81009028.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c81009028.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(c81009028.splimit)
	e1:SetReset(RESET_PHASE+PHASE_END)
	Duel.RegisterEffect(e1,tp)
end
function c81009028.splimit(e,c,sump,sumtype,sumpos,targetp,se)
