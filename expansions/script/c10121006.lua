...
function cm.dfilter(c,tp)
	return c:GetDestination()==LOCATION_GRAVE and c:GetOwner()~=tp and not c:IsLocation(LOCATION_OVERLAY) and not c:IsType(TYPE_SPELL+TYPE_TRAP)
end
