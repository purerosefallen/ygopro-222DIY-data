...
function cm.initial_effect(c)
	...
	e4:SetTargetRange(0,LOCATION_MZONE+LOCATION_DECK+LOCATION_GRAVE+LOCATION_HAND+LOCATION_REMOVED)
	...
	e5:SetTargetRange(0,LOCATION_MZONE+LOCATION_DECK+LOCATION_EXTRA+LOCATION_GRAVE+LOCATION_HAND+LOCATION_REMOVED)
