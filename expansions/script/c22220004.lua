...
function c22220004.eqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return c:GetFlagEffect(22220004)==0 and Duel.GetLocationCount(tp,LOCATION_SZONE)>0
		and Duel.IsExistingTarget(c22220004.eqfilter,tp,LOCATION_MZONE,0,1,c) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_EQUIP)
	local g=Duel.SelectTarget(tp,c22220004.eqfilter,tp,LOCATION_MZONE,0,1,1,c)
...
function c22220004.thfilter(c,tp)
	return c:IsSetCard(0x50f) and c:IsType(TYPE_UNION) and Duel.IsExistingMatchingCard(c22220004.thfilter2,tp,LOCATION_MZONE,0,1,nil,c) and not c:IsCode(22220004)
end
