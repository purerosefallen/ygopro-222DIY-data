...
function c47510101.cfilter(c)
    return (c:IsSetCard(0x5da) or c:IsFusionAttribute(ATTRIBUTE_FIRE))
...
function c47510101.spfilter2(c,tp,mc)
    return (c:IsSetCard(0x5da) and mc:IsFusionAttribute(ATTRIBUTE_FIRE)
        or c:IsFusionAttribute(ATTRIBUTE_FIRE) and mc:IsSetCard(0x5da))
