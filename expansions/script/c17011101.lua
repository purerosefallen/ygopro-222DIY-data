...
function cm.thfilter(c)
	return (c:IsType(TYPE_PENDULUM) or not c:IsLocation(LOCATION_DECK)) and c:IsAbleToHand()
		and (c:IsType(TYPE_SPELL) or not c:IsLocation(LOCATION_GRAVE)) and c:IsAbleToHand()
end
