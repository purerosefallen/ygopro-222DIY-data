...
function c65020046.reop(e,tp,eg,ep,ev,re,r,rp)
	if not Duel.IsExistingMatchingCard(c65020046.thfil,tp,LOCATION_DECK+LOCATION_GRAVE,0,2,nil) then return end
	local g=Duel.SelectMatchingCard(tp,c65020046.thfil,tp,LOCATION_DECK+LOCATION_GRAVE,0,2,2,nil)
