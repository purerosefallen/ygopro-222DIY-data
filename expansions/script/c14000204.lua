...
function cm.initial_effect(c)
	...
	e3:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DAMAGE_CAL+EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_CANNOT_NEGATE)
...
function cm.discon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(14000203)~=0 and re:GetHandler()~=e:GetHandler() and e:GetHandler():GetFlagEffect(m)<2 and not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED)
end
