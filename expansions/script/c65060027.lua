--龙逆术-显现
function c65060027.initial_effect(c)
	...
	e1:SetCountLimit(1,65060027)
	e1:SetCondition(c65060027.spcon)
	e1:SetTarget(c65060027.sptg)
	e1:SetOperation(c65060027.spop)
	c:RegisterEffect(e1)
	--Dual
...
function c65060027.damop(e,tp,eg,ep,ev,re,r,rp)
...
function c65060027.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
