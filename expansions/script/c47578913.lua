...
function c47578913.initial_effect(c)
    ...
    e5:SetCondition(c47578913.ddamcon)
    e5:SetOperation(c47578913.ddamop)
    c:RegisterEffect(e5)
    --indes
    local e4=Effect.CreateEffect(c)
    e4:SetType(EFFECT_TYPE_SINGLE)
    e4:SetCode(EFFECT_IMMUNE_EFFECT)
    e4:SetCondition(c47578913.indcon)
    e4:SetValue(1)
    c:RegisterEffect(e4)
    --cannot be target
...
function c47578913.indfilter(c)
    return c:IsFaceup() and c:IsCode(47570008)
end
function c47578913.indcon(e)
    return Duel.IsExistingMatchingCard(c47578913.indfilter,e:GetOwnerPlayer(),LOCATION_MZONE,0,1,nil)
end
