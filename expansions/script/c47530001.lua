...
function c47530001.cfilter(c,tp,zone)
...
function c47530001.hspcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c47530001.cfilter,1,nil,tp,e:GetHandler():GetLinkedZone())
end
...
function c47530001.hspop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c47530001.hspfilter,tp,LOCATION_GRAVE,0,1,1,nil,e,tp)
	local tc=g:GetFirst()
