...
function cm.discon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(14000202)~=0 and re:GetHandler()~=e:GetHandler() and e:GetHandler():GetFlagEffect(m)==0 and not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED)
end
