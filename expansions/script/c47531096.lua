...
function c47531096.cfilter(c,tp)
    return not Duel.IsExistingMatchingCard(c47531096.drfilter1,tp,LOCATION_MZONE,0,1,c,c:GetCode()) and not Duel.IsExistingMatchingCard(c47531096.drfilter2,tp,LOCATION_MZONE,0,1,c,c:GetRace()) and not Duel.IsExistingMatchingCard(c47531096.drfilter3,tp,LOCATION_MZONE,0,1,c,c:GetAttribute()) and not Duel.IsExistingMatchingCard(c47531096.drfilter4,tp,LOCATION_MZONE,0,1,c,c:GetLevel())
end
