...
function c81015017.initial_effect(c)
	...
	e1:SetCondition(c81015017.npcon)
...
function c81015017.eeilter(c)
	return c:IsFaceup() and c:IsSetCard(0x81a)
end
function c81015017.npcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c81015017.eeilter,tp,LOCATION_MZONE,0,1,nil)
end
