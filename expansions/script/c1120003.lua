--读心少女·米切尔
function c1120003.initial_effect(c)
	...
	e1:SetCondition(c1120003.con1)
	c:RegisterEffect(e1)
--
	local e2=Effect.CreateEffect(c)
	e2:SetType(EFFECT_TYPE_SINGLE)
	e2:SetCode(EFFECT_IMMUNE_EFFECT)
	e2:SetCondition(c1120003.con2)
	e2:SetValue(c1120003.efilter2)
	c:RegisterEffect(e2)
--
	...
	e3:SetOperation(c1120003.op3)
	c:RegisterEffect(e3)
--
end
--
function c1120003.con1(e,c)
	if c==nil then return true end
	return Duel.GetTurnCount()>1 
		and Duel.GetMZoneCount(c:GetControler())>0
end
--
function c1120003.con2(e)
	local p=e:GetHandlerPlayer()
	return p==Duel.GetTurnPlayer()
end
--
function c1120003.efilter2(e,re)
	return e:GetOwnerPlayer()~=re:GetOwnerPlayer()
end
--
function c1120003.op3(e,tp,eg,ep,ev,re,r,rp)
