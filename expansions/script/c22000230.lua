...
function c22000230.initial_effect(c)
	...
	e1:SetCountLimit(1,22000230+EFFECT_COUNT_CODE_OATH)
	e1:SetTarget(c22000230.target)
	e1:SetOperation(c22000230.activate)
	c:RegisterEffect(e1)
	--search
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringid(22000230,2))
	...
	e2:SetTarget(c22000230.target1)
	e2:SetOperation(c22000230.activate1)
	c:RegisterEffect(e2)
end
...
function c22000230.target1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(c22000230.filter0,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectTarget(tp,c22000230.filter0,tp,LOCATION_GRAVE,0,1,1,nil,e,tp)
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,g,1,0,0)
end
function c22000230.activate1(e,tp,eg,ep,ev,re,r,rp)
