...
function c47510001.initial_effect(c)
	...
	e8:SetOperation(c47510001.sumsuc)
	c:RegisterEffect(e8)
	local e9=e8:Clone()
...
function c47510001.thop2(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_SOUND,0,aux.Stringid(47510001,3))
end
...
function c47510001.ssop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_SOUND,0,aux.Stringid(47510001,4))
end
...
function c47510001.sumsuc(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SOUND,0,aux.Stringid(47510001,1))
	Duel.Hint(HINT_MUSIC,0,aux.Stringid(47510001,2))
end 