...
function c9980407.initial_effect(c)
	...
	e1:SetCountLimit(1,9980407)
	e1:SetCondition(c9980407.descon)
	e1:SetTarget(c9980407.destg)
...
function c9980407.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
