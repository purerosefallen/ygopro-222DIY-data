--Answer·西川保奈美
function c81011000.initial_effect(c)
	--negate
	...
	e1:SetCountLimit(1,81011000)
	e1:SetCondition(c81011000.discon)
	e1:SetCost(c81011000.discost)
	e1:SetTarget(c81011000.distg)
	e1:SetOperation(c81011000.disop)
	c:RegisterEffect(e1)
end
function c81011000.discon(e,tp,eg,ep,ev,re,r,rp)
...
function c81011000.discost(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:IsDiscardable() end
	Duel.SendtoGrave(c,REASON_COST+REASON_DISCARD)
end
function c81011000.distg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_NEGATE,eg,1,0,0)
end
function c81011000.disop(e,tp,eg,ep,ev,re,r,rp)
