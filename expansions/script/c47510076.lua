...
function c47510076.target(e,tp,eg,ep,ev,re,r,rp,chk)
    if chk==0 then return Duel.IsExistingMatchingCard(c47510076.filter,tp,LOCATION_MZONE,0,1,nil) end
end
function c47510076.operation(e,tp,eg,ep,ev,re,r,rp)
    local g=Duel.GetMatchingGroup(c47510076.filter,tp,LOCATION_MZONE,0,nil)
