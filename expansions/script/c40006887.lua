...
function c40006887.initial_effect(c)
	...
	e5:SetOperation(c40006887.aclimit1)
	c:RegisterEffect(e5)
	...
	e6:SetCondition(c40006887.econ1)
	e6:SetValue(c40006887.elimit)
	c:RegisterEffect(e6)
	local e4=e5:Clone()
	e4:SetOperation(c40006887.aclimit3)
	c:RegisterEffect(e4)
	local e7=e6:Clone()
	e7:SetCondition(c40006887.econ2)
