...
function cm.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SendtoGrave(tc,REASON_EFFECT)~=0 and tc:IsFaceup() and tc:IsRace(RACE_ZOMBIE) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and tc:IsCanBeSpecialSummoned(e,0,tp,false,false) and Duel.SelectYesNo(tp,aux.Stringid(m,1)) then
		Duel.BreakEffect()
