...
function c65010075.initial_effect(c)
	--synchro summon
	aux.AddSynchroProcedure(c,c65010075.tunefil,c65010075.nottunefil,1)
	c:EnableReviveLimit()
	--mat check
...
function c65010075.nottunefil(c)
	return c.setname=="RagnaTravellers" and c:IsType(TYPE_SYNCHRO) and not c:IsType(TYPE_TUNER)
end
