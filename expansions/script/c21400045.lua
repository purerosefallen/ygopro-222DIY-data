...
function c21400045.initial_effect(c)
	...
	e4:SetCondition(c21400045.dtcon)
	c:RegisterEffect(e4)

end

function c21400045.dtcon(e,tp,eg,ep,ev,re,r,rp)
...
function c21400045.jffl(c,e,tp,pp)
	return (c:IsLocation(LOCATION_HAND) or c:IsFaceup()) and c:IsType(TYPE_PENDULUM) and c:IsRace(RACE_PLANT) and not c:IsForbidden() and c:IsCanBeSpecialSummoned(e,0,pp,false,false,POS_FACEUP,pp)
end
...
function c21400045.jfop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) then
		...
		if(Duel.IsExistingTarget(c21400045.jffl,tp,LOCATION_EXTRA+LOCATION_HAND,0,1,nil,e,tp,pp) and Duel.SelectYesNo(tp,aux.Stringid(21400045,3))) then
