--宇宙战争兵器 量产炮 烬灭炮
function c13257232.initial_effect(c)
	c:EnableReviveLimit()
	--equip limit
	...
	e11:SetValue(c13257232.eqlimit)
	...
	e12:SetCondition(c13257232.econ)
	e12:SetValue(c13257232.efilter)
	c:RegisterEffect(e12)
	--atk up
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_EQUIP)
	e1:SetCode(EFFECT_UPDATE_ATTACK)
	e1:SetValue(c13257232.value)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	...
	e4:SetDescription(aux.Stringid(13257232,0))
	e4:SetCategory(CATEGORY_DESTROY)
	e4:SetCode(EVENT_PHASE+PHASE_END)
	e4:SetRange(LOCATION_SZONE)
	e4:SetCountLimit(1)
	e4:SetTarget(c13257232.destg)
	e4:SetOperation(c13257232.desop)
	c:RegisterEffect(e4)
	c:RegisterFlagEffect(13257201,0,0,0,1)
	
end
function c13257232.eqlimit(e,c)
...
function c13257232.econ(e)
	return e:GetHandler():GetEquipTarget()
end
function c13257232.efilter(e,re)
	return e:GetHandlerPlayer()~=re:GetOwnerPlayer()
end
function c13257232.value(e,c)
	return c:GetLevel()*200
end
function c13257232.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c13257232.desop(e,tp,eg,ep,ev,re,r,rp)
	local ec=e:GetHandler():GetEquipTarget()
