...
function c81015016.matfilter(c)
	return c:IsLinkSetCard(0x814) and not c:IsLinkType(TYPE_LINK)
end
function c81015016.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_LINK)
end
function c81015016.filter(c,e,tp)
	return c:IsSetCard(0x814) and not c:IsType(TYPE_LINK) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c81015016.thfilter1(c)
	return c:IsSetCard(0x814) and c:IsType(TYPE_SPELL) and c:IsAbleToHand()
end
