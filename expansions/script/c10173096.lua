...
function c10173096.tdfilter(c,tp,rc)
	...
	return c:IsFaceup() and c:IsRace(RACE_DRAGON) and g:GetClassCount(Card.IsCode)>=3 and Duel.IsExistingMatchingCard(Card.IsAbleToDeck,tp,LOCATION_ONFIELD+LOCATION_REMOVED,LOCATION_ONFIELD+LOCATION_REMOVED,1,Group.FromCards(c,rc))
end
...
function c10173096.activate(e,tp,eg,ep,ev,re,r,rp)
