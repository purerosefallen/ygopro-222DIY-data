...
function c10173079.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if mg:GetCount()~=2 or Duel.GetLocationCountFromEx(tp,tp,g)<=0 then return end
	local sg=Duel.GetMatchingGroup(c10173079.ffilter2,tp,LOCATION_EXTRA,0,nil,e,tp,g)
...
function c10173079.ffilter2(c,e,tp,mg)
