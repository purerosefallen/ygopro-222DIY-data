...
function cm.spop(e,tp,eg,ep,ev,re,r,rp)
    ...
    if ct==4 or ct==6 or ct==8 or ct==9 or ct==10 or ct==12  then 
    Duel.RegisterFlagEffect(tp,m,0,0,1) end
end
...
function cm.setop(e,tp,eg,ep,ev,re,r,rp)
    ...
    if ct==2 or ct==3 or ct==5 or ct==7 or ct==11 or ct==13
    then 
    Duel.RegisterFlagEffect(tp,m,0,0,1) end
    end
end
