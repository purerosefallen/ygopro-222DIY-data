--Answer·西川保奈美
function c81011059.initial_effect(c)
	--negate
	...
	e1:SetCountLimit(1,81011059)
	e1:SetCondition(c81011059.discon)
	e1:SetCost(c81011059.discost)
	e1:SetTarget(c81011059.distg)
	e1:SetOperation(c81011059.disop)
	c:RegisterEffect(e1)
end
function c81011059.discon(e,tp,eg,ep,ev,re,r,rp)
...
function c81011059.discost(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:IsDiscardable() end
	Duel.SendtoGrave(c,REASON_COST+REASON_DISCARD)
end
function c81011059.distg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return not re:GetHandler():IsStatus(STATUS_DISABLED) end
	Duel.SetOperationInfo(0,CATEGORY_DISABLE,eg,1,0,0)
end
function c81011059.disop(e,tp,eg,ep,ev,re,r,rp)
