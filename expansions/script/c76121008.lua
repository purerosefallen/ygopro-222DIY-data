...
function c76121008.initial_effect(c)
	...
	e2:SetTarget(c76121008.efftg)
	e2:SetCode(76121008)
	c:RegisterEffect(e2)
	--to grave
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringid(76121008,0))
	...
	e3:SetCountLimit(1)
	e3:SetTarget(c76121008.tgtg)
	e3:SetOperation(c76121008.tgop)
	c:RegisterEffect(e3)
end
function c76121008.efftg(e,c)
	return c:IsSetCard(0xea1) and c:IsType(TYPE_QUICKPLAY)
end
